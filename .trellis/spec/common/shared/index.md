...
| [Tokscale Contract](../../backend/backend/tokscale-guidelines.md) | Shared public AI Cost snapshot DTO, client display names, and base-config username contract | Filled |
...
- [ ] Deployment/operations changes include a tested one-command script and matching documentation
